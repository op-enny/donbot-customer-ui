...
export const translations: Record<SupportedLocale, Record<string, string>> = {
  de: {
    ...
    // Market specific
    'market_hero_title': 'Frische Lebensmittel geliefert',
    'market_hero_subtitle': 'Bestellen Sie bei lokalen Märkten und erhalten Sie frische Produkte direkt an Ihre Tür',
    'market_search_placeholder': 'Märkte, Produkte suchen...',
    'market_search_button': 'Suchen',
    'market_all_markets': 'Alle Märkte',
    'market_grocery': 'Lebensmittel',
    'market_organic': 'Bio',
    'market_fresh_produce': 'Frische Produkte',
    'market_bakery': 'Bäckerei',
    'market_butcher': 'Metzger',
    'market_nearby': 'Märkte in der Nähe',
    'market_search_results': 'Suche',
    'market_filter': 'Filter',
    'market_found': 'Markt gefunden',
    'market_found_plural': 'Märkte gefunden',
  ...
  en: {
    ...
    // Market specific
    'market_hero_title': 'Fresh Groceries Delivered',
    'market_hero_subtitle': 'Order from local markets and get fresh products delivered to your door',
    'market_search_placeholder': 'Search markets, products...',
    'market_search_button': 'Search',
    'market_all_markets': 'All Markets',
    'market_grocery': 'Grocery',
    'market_organic': 'Organic',
    'market_fresh_produce': 'Fresh Produce',
    'market_bakery': 'Bakery',
    'market_butcher': 'Butcher',
    'market_nearby': 'Markets Near You',
    'market_search_results': 'Search',
    'market_filter': 'Filter',
    'market_found': 'market found',
    'market_found_plural': 'markets found',
  ...
  tr: {
    ...
    // Market specific
    'market_hero_title': 'Taze Ürünler Kapınızda',
    'market_hero_subtitle': 'Yerel marketlerden sipariş verin, taze ürünler kapınıza gelsin',
    'market_search_placeholder': 'Market, ürün ara...',
    'market_search_button': 'Ara',
    'market_all_markets': 'Tüm Marketler',
    'market_grocery': 'Market',
    'market_organic': 'Organik',
    'market_fresh_produce': 'Taze Ürünler',
    'market_bakery': 'Fırın',
    'market_butcher': 'Kasap',
    'market_nearby': 'Yakındaki Marketler',
    'market_search_results': 'Arama',
    'market_filter': 'Filtrele',
    'market_found': 'market bulundu',
    'market_found_plural': 'market bulundu',
