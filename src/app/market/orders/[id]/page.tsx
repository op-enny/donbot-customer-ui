...
import { ArrowLeft, CheckCircle, Clock, AlertCircle, Package, Truck, Calendar } from 'lucide-react';
import { useOrderHistoryStore } from '@/lib/store/orderHistoryStore';

export default function MarketOrderTrackingPage() {
  ...
  useEffect(() => {
    ...
    if (!token) {
      setError('Tracking token missing. Please check your order confirmation.');
      setIsLoading(false);
      return;
    }
  ...
  }, [orderId, token, urlToken, historyOrder?.trackingToken]);
      ...
      <div className="container mx-auto px-4 pt-6">
        ...
        {!isLoading && error && (
          <div className="bg-white rounded-2xl shadow-md p-6 border border-red-200 text-red-800 flex gap-3">
            ...
            <div>
              <h2 className="font-semibold text-red-900 mb-1">Unable to Track Order</h2>
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 space-y-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  From: <span className="font-semibold">{order.restaurant_name || 'Market'}</span>
                </p>
              </div>
              <div
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="rounded-xl border border-gray-100 p-4 bg-gray-50">
                ...
                <p className="text-sm text-gray-600">
                  Type: <span className="font-medium capitalize">{order.delivery_method}</span>
                </p>
            ...
            {order.delivery_slot_id && (
              <div className="rounded-xl border border-green-200 p-4 bg-green-50">
                <div className="flex items-center gap-2 text-green-700 mb-2">
                  ...
                  <span className="font-semibold text-sm">Scheduled Delivery</span>
                </div>
            ...
            <div className="flex gap-3">
              <Link
                href="/"
                className="inline-flex items-center justify-center px-5 py-3 rounded-full bg-green-600 text-white font-semibold hover:bg-green-700 transition-colors"
              >
                Continue Shopping
              </Link>
              <Link
