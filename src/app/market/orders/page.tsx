...
import { Package, Clock, CheckCircle, XCircle, Truck, ShoppingCart, ArrowLeft } from 'lucide-react';
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="container mx-auto px-4 py-6">
          ...
          <p className="text-sm text-gray-600 mt-1">
            {orders.length} order{orders.length !== 1 ? 's' : ''} in the last 7 days
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-6">
        {orders.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">Start shopping from your favorite local markets</p>
            <Link
              href="/"
              ...
              >
                ...
                {['new', 'confirmed', 'preparing', 'ready', 'out_for_delivery'].includes(
                  ...
                  <div className="mt-3 pt-3 border-t border-gray-200">
                    <button className="w-full bg-green-600 hover:bg-green-700 text-white font-semibold py-2 rounded-lg transition-colors text-sm flex items-center justify-center gap-2">
                ...
                {order.status === 'completed' && (
                  <div className="mt-3 pt-3 border-t border-gray-200">
                    <button className="w-full border-2 border-green-600 text-green-600 hover:bg-green-50 font-semibold py-2 rounded-lg transition-colors text-sm">
                      Order Again
                    </button>
                  </div>
                )}
